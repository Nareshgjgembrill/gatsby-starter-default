          ...
          <Card className="card-default text-center h-100 text-center">
            ...
            <CardBody className="d-flex pb-0" style={{ height: '200px' }}>
              {(topCadencesError && (
                ...
                (topCadencesData?.length > 0 && (
                  <Chart
                    ...
                    legends={[
                      {
                        dataFrom: 'keys',
                        data: Object.keys(topCadencesData[0])
                          .slice(1)
                          .map((id, index) => {
                            return {
                              color:
                ...
                (!topCadencesLoading &&
                  (!topCadencesData || topCadencesData?.length === 0) && (
